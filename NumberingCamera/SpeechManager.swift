...
class SpeechRecognizer: NSObject, ObservableObject, SFSpeechRecognizerDelegate {
    ...
    func processRecognizedText(_ rawText: String) -> String {
        ...
        // 1. 다음절 수사 및 "파이브" 형태를 최우선 치환하여 글자 훼손 방지
        let multiCharNumbers: [String: String] = [
            "원": "1", "투": "2", "쓰리": "3", "포": "4", "파이브": "5",
            "식스": "6", "세븐": "7", "에잇": "8", "나인": "9", "텐": "10"
        ]
        for (key, value) in multiCharNumbers {
            text = text.replacingOccurrences(of: key, with: value)
        }

        // 2. Settings / 사용자 정의 사전 동적 치환 (긴 단어부터 우선 적용)
        ...
        // 5. 단일 한글 숫자 치환 (1글자)
        let singleCharNumbers: [String: String] = [
            "일": "1", "이": "2", "삼": "3", "사": "4", "오": "5",
            "육": "6", "칠": "7", "팔": "8", "구": "9", "십": "10"
        ]
        for (key, value) in singleCharNumbers {
            text = text.replacingOccurrences(of: key, with: value)
        }
